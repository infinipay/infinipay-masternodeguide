![Example-Logo](https://i.imgur.com/Lxp6sJK.png)
# Infinipay Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Infinipay Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/UcfNuGK)
***
## Requirements
1) **1,000 Infinipay coins.**
...
`wget -q https://github.com/infinipay/infinipay/releases/download/v1.0/infinipay.sh`
***
...
![Example-installing](https://i.imgur.com/W7XhGXU.png)
***
...
***Step 2***
* Send EXACLY 1,000 Infinipay to a receive address within your wallet.
***
